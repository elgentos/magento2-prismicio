...
class AppendTrailingSlashes
{
     ...
     *     <plugin name="elgentos_prismicio_appendtrailingslashes"
     *             type="Elgentos\PrismicIO\Plugin\ViewModel\LinkResolver\AppendTrailingSlashes" />
     * </type>
     */
     ...
     * @return string
     */
    public function afterGetFormattedUrl(
